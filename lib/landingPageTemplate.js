...
export const LP_STYLES = `
  ...
  .lp-root .lp-display { font-family: "Lora", Georgia, serif; }
...
const LP_STYLES_V2 = `
  ...
  .lp-emotional-media { min-width: 0; }
...
<link href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,600;1,500&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@500&display=swap" rel="stylesheet" />
<style>${styles}</style>
</head>
<body>
${bodyHtml}
